            ...
            <Col>
              <Card>
                <Card.Body>
                  ...
                  <Link to="/protected/FamilyUnion">Go to Family Union's Document</Link>
                </Card.Body>
              </Card>
            </Col>
            ...
            <Col>
              <Card>
                  <Card.Body>
                    ...
                    <Link to="/protected/FileCombination">Go to File Combination's Document</Link>
                  </Card.Body>
                </Card>    
            </Col>
            ...
            <Col>
              <Card>
                <Card.Body>
                  ...
                  <Link to="/protected/CantonChange">Go to Canton Change's Document</Link>
                </Card.Body>
              </Card>
            </Col>
            ...
            <Col>
              <Card>
                <Card.Body>
                  ...
                  <Link to="/protected/CampChange">Go to Camp Change's Document</Link>
                </Card.Body>
              </Card>
